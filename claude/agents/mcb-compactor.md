...
6. If a newly saved fact replaces an older conflicting or duplicate memory found by `memory_search`, call `mcp__mcb__memory_supersede` with the old and new memory IDs.
